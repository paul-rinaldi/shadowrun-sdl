      ...
      if (weapon.name.substring(0, 3) === "Bow") {
        ...
        if (this.state.mounted !== "Unmounted") {
          ...
          testVariables.unshift(
            ...
            <span style={{ color: "#00802b", fontWeight: 495 }}>
              {actualSkill.specialization
                ? actualSkill.specialization + " Spec"
                : ""}
            </span>,
            mode && weapon.RC > 0 ? "+" : "",
            mode && weapon.RC > 0 ? "Recoil Compensation" : ""
          );
          testValues.unshift(
            actualSkill.rating,
            "+",
    ...
    return (
      <div className={"Action"} id={"rangedWeaponSelector"}>
        ...
        />
        {
          <h3
            style={{
              display: this.state.rangedWeaponSelected ? "block" : "none",
            }}
          >
            Mode selection
          </h3>
        ...
        {this.state.rangedWeaponSelected !== undefined &&
